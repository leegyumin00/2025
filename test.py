...
# --- 2. 독후감 저장을 위한 세션 상태 초기화 (기존과 동일) ---
if 'reviews' not in st.session_state:
    st.session_state.reviews = []

# --- 3. 학년별 추천 도서 데이터 (수정된 부분) ---
...
recommended_books = {
    "1학년": [
        ...
        {"제목": "달님 안녕", "저자": "하야시 아키코", "설명": "아기가 달님에게 인사하며 잠이 드는 단순하고 반복적인 내용으로, 아이들이 안정감을 느끼고 세상을 인지하는 데 도움을 줍니다."},
        {"제목": "구름빵", "저자": "백희나", "설명": "구름으로 만든 빵을 먹고 하늘을 날아 아빠에게 빵을 가져다주는 상상력 가득한 이야기로, 따뜻한 가족애를 느낄 수 있습니다."},
        {"제목": "알사탕", "저자": "백희나", "설명": "외로운 아이가 사탕을 먹을 때마다 다른 사람들의 마음의 소리를 듣게 되면서 변화하는 이야기로, 소통의 소중함을 알려줍니다."}
    ],
    "2학년": [
        ...
        {"제목": "마당을 나온 암탉", "저자": "황선미", "설명": "양계장 암탉 잎싹이가 알을 품는 꿈을 이루기 위해 고난을 겪고 진정한 행복을 찾아가는 이야기입니다. 생명의 소중함과 모성애를 느낄 수 있습니다."},
        {"제목": "돼지책", "저자": "앤서니 브라운", "설명": "가족들의 무시와 무관심 속에서 돼지로 변해가는 엄마의 이야기를 통해 가사와 가족의 역할을 되새기게 하는 그림책입니다."},
        {"제목": "팥죽 할머니와 호랑이", "저자": "최정란", "설명": "재치 있는 할머니와 동물 친구들이 지혜를 모아 호랑이를 물리치는 전래동화로, 약한 존재도 힘을 합치면 강해질 수 있다는 교훈을 줍니다."}
    ],
    "3학년": [
        ...
        {"제목": "내 짝꿍 최영대", "저자": "채인선", "설명": "아이가 장애인 친구와 함께 생활하며 편견을 깨고 우정을 나누는 이야기로, 다름을 인정하고 이해하는 마음을 길러줍니다."},
        {"제목": "개와 고양이", "저자": "박완서", "설명": "어린 시절 작가의 시선으로 개와 고양이를 통해 가족 간의 미묘한 관계와 일상을 따뜻하게 그려낸 동화입니다."},
        {"제목": "마법의 설탕 두 조각", "저자": "미하엘 엔데", "설명": "자신이 원하는 대로 몸집을 키우고 줄일 수 있는 설탕을 발견한 소년의 이야기로, 욕심과 행복의 의미를 생각하게 합니다."}
    ],
    "4학년": [
        ...
        {"제목": "책 읽어주는 아이", "저자": "베른하르트 슐링크", "설명": "문맹인 여인을 사랑한 소년의 이야기로, 역사의 비극 속에서 지식과 사랑, 용서의 의미를 깊이 있게 다룬 소설입니다."},
        {"제목": "괭이부리말 아이들", "저자": "김중미", "설명": "인천 만석동 괭이부리말 아이들의 험난한 삶과 그 속에서도 피어나는 희망과 우정을 그린 이야기로, 가난하지만 꿋꿋하게 살아가는 아이들의 모습을 보여줍니다."},
        {"제목": "수학 귀신", "저자": "한스 마그누스 엔첸스베르거", "설명": "수학을 싫어하는 로베르트의 꿈에 수학 귀신이 나타나 흥미로운 수학의 세계로 안내하는 이야기로, 수학을 즐겁게 배울 수 있도록 돕습니다."}
    ],
    "5학년": [
        ...
        {"제목": "나의 라임 오렌지나무", "저자": "조제 마우루 지 바스콘셀루스", "설명": "가난하지만 상상력이 풍부한 소년 제제의 성장통과 상처, 그리고 치유를 그린 감동적인 이야기입니다."},
        {"제목": "비둘기 집", "저자": "고정욱", "설명": "장애를 가진 아이들이 모여 사는 비둘기 집에 대한 편견과 차별을 이겨내고 희망을 찾아가는 이야기입니다. 따뜻한 시선으로 장애인에 대한 인식을 개선합니다."},
        {"제목": "정의란 무엇인가", "저자": "마이클 샌델", "설명": "고전 철학부터 현대의 실제 사례까지 다양한 관점을 통해 정의란 무엇인지를 탐색하는 책입니다. 복잡한 사회 문제를 비판적으로 생각하게 합니다."}
    ],
    "6학년": [
        ...
        {"제목": "난쟁이 피터", "저자": "오트프리트 프로이슬러", "설명": "난쟁이로 변한 소년의 모험을 통해 진정한 아름다움과 내면의 가치를 깨닫게 하는 독일의 고전 동화입니다."},
        {"제목": "데미안", "저자": "헤르만 헤세", "설명": "싱클레어라는 소년이 '데미안'과의 만남을 통해 자아를 찾아가는 과정을 그린 성장 소설로, 청소년 시기의 고민과 혼란을 다룹니다."},
        {"제목": "페스트", "저자": "알베르 카뮈", "설명": "갑작스러운 전염병으로 봉쇄된 도시에서 인간 군상이 어떻게 반응하는지를 그린 소설로, 삶과 죽음, 그리고 인간의 존재론적 고뇌를 탐색합니다."}
    ]
}
